<div class="bg-footer">
    ...
    <div class=" p-3 d-flex  justify-content-around">
        <ul>
            ...
            <li>
                <a target="_blank" class="footer-link nav-link"
                    href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">Scarica l'app di DeliveBoo</a>
            </li>
        </ul>
        ...
        <ul>
            ...
            <li>
                <a target="_blank" class="footer-link nav-link"
                    href="https://www.youtube.com/watch?v=4UbmI_S7XjI">Informazioni su DeliveBoo</a>
            </li>
            <li>
